...
class UartRemote:
    ...
    :param port: The hardware uart port used to by `UartRemote` class
    :param baudrate: The baudraste at which the UART communicates, defaults to 115200
    :param timeout: The timeout (in ms) for waiting for data coming in on the UART, default to 1500
    :param debug: A flag to generate debug output, default to False
    :param rx_pin: The pin on which the UART will receive information, default to 18
    :param tx_pin: The pin on which the UART will receive information, default to 19
    """
    commands={}
    command_array=[]
    command_formats={}
    ...
    def echo(self, *s):
        """Returns the same string and is added to the `commands`
